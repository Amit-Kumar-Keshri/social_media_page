      ...
      <div class="d-flex flex-wrap">
        ...
        ?>
            <div class="card card-one m-3">
              ...
              <h3><a href="#" class="profile-link"><?= $value[1]; ?></a></h3>
              <div class="desc">
                ...
                <?php } else { ?>
                  <button class="btn btn-primary pull-right add_friend_btn" style="visibility: hidden;" data-id="<?= $value[0]; ?>">Add Friend</button>
