...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($name_error == "" && $email_error == "" && $username_error == "" && $password_error == "" && $phone_error == "" && $address_error == "" && $gender_error == "") {
    ...
    if ($result->num_rows > 0) {
      ...
      $insert_query = "INSERT INTO tb_registration (name, email, password, phone, address, gender, profile_image) VALUES ('$name', '$email', '$password', '$phone', '$address', '$gender','$profile_image')";
